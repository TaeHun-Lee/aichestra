...
- `pnpm build` fails: `scripts/build.mjs` requires root `AICHESTRA_BOOTSTRAP.md`, but the file exists only at `design_docs/AICHESTRA_BOOTSTRAP.md`.
...
| Phase 4 | `planned_only` | Work orders in `design_docs/AICHESTRA_CODEX_PHASE3_TO_PHASE4_WORK_ORDERS.md`; blocked docs in `docs/phase-4-preparation-blocked.md` and `docs/phase-4-v0-blocked.md`. | No `FailureSignal`, `FailureCluster`, `ImprovementCandidate`, `ImprovementProposal`, `EvalRequirement`, `CanaryRolloutPlan`, `AutoImprovementSafetyPolicy`, `AutoImprovementEngine`, `MockAutoImprovementEngine`, `DraftRegistryChange`, or `ProposalReadiness` implementation. | Yes, for Phase 4 work. | Yes. |
...
- Safe documentation references: `README.md`, `design_docs/AICHESTRA_BOOTSTRAP.md`, `design_docs/AICHESTRA_CODEX_*`, `docs/phase-1-2-completion-audit.md`, `docs/phase-3-hardening-plan.md`, `docs/phase-progress-audit.md`, `docs/security-model.md`.
...
| `pnpm build` | fail | `node scripts/build.mjs`; `ENOENT` for root `AICHESTRA_BOOTSTRAP.md`. | n/a | Build script requires `AICHESTRA_BOOTSTRAP.md`, but current file is `design_docs/AICHESTRA_BOOTSTRAP.md`. |
...
- `docs/phase-3-registry-v0.md`, `docs/phase-3-registry-hardening-v1.md`, `docs/phase-3-operational-hardening-v2.md`, `docs/phase-3-packaging-versioning-v3.md`, and `docs/phase-3-completion-gap.md` broadly match implemented Phase 3 surfaces.
- `docs/conflict-manager-v0.md` and `docs/conflict-manager-v1.md` match the Phase 2 mock/local-only implementation direction.
- `docs/phase-4-preparation-blocked.md` and `docs/phase-4-v0-blocked.md` accurately state that Phase 4 work is blocked.

Stale docs:

- `docs/phase-progress-audit.md` says `pnpm test` and `pnpm build` pass with 68 tests. Current validation shows `pnpm test` fails 1 of 68 and `pnpm build` fails due missing root `AICHESTRA_BOOTSTRAP.md`.
- `docs/phase-progress-audit.md` references root `AICHESTRA_BOOTSTRAP.md`; current repository has `design_docs/AICHESTRA_BOOTSTRAP.md`.
...
- `docs/phase-4-preparation.md` is missing.
- `docs/phase-4-auto-improvement-v0.md` is missing.
...
2. `pnpm build` fails.
   ...
   - Current file exists at `design_docs/AICHESTRA_BOOTSTRAP.md`, not repo root.

3. Phase 4 cannot proceed.
   - Evidence: no Phase 4 preparation implementation or docs; `docs/phase-4-preparation.md` absent.

### Important Follow-ups

- Update stale `docs/phase-progress-audit.md` after validation blockers are fixed.
...
4. Update `docs/phase-progress-audit.md`.
