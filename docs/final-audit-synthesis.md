...
- `docs/final-completion-audit.codex.md`
- `docs/final-completion-audit.claude.md`
...
- `scripts/build.mjs` requires root `AICHESTRA_BOOTSTRAP.md`, while the current file exists at `design_docs/AICHESTRA_BOOTSTRAP.md`.
...
- `pnpm test` fails.
- `pnpm build` fails.
- `docs/phase-4-preparation.md` is absent.
...
2. `pnpm build` fails.
   ...
   - Current repository has `design_docs/AICHESTRA_BOOTSTRAP.md`, not root `AICHESTRA_BOOTSTRAP.md`.

3. Phase 4 cannot begin.
   - Evidence: `docs/phase-4-preparation.md` is absent and Phase 4 implementation concepts are missing from `apps/`, `packages/`, and `tests/`.
