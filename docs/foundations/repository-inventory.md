...
Production Deployment Readiness Planning v0, GitHub App / Production Webhook Hardening Planning v0, Persistent DB Production Operations v1, and Secret Backend Migration Planning v0 add read-only seeded deployment, GitHub App, database operations, and secret backend migration readiness models in `packages/deployment-readiness`. These are planning metadata only and do not require persistence in their current milestones.
