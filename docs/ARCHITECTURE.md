...
- Approval requires semantic review evidence that matches the current Change Manifest id/hash, verified candidate, changed files, and sandbox check evidence; changing any of those after review sends the candidate back to `aich review`.
