...
Real Git Adapter v1 now uses these static rules for controlled GitHub branch/PR creation. Next recommended task: Dashboard API-backed read model migration, or LLM Gateway v1 if controlled real provider calls should be enabled next.
