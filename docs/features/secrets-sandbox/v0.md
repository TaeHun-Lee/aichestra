...
SecretRef-backed Provider Credentials v1, Production Auth/RBAC Planning v0, LLM Gateway v2, and MCP Gateway v0 are implemented for mock-first attribution, credential boundaries, and tool governance. Next recommended task: production deployment readiness planning, or GitHub App / production webhook hardening planning.
