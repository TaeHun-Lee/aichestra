...
SecretRef-backed Provider Credentials v1, Production Auth/RBAC Planning v0, LLM Gateway v2, MCP Gateway v0, Production Deployment Readiness Planning v0, Observability / Audit Retention v0, GitHub App / Production Webhook Hardening Planning v0, Persistent DB Production Operations v1, and Secret Backend Migration Planning v0 are implemented for mock-first attribution, credential boundaries, tool governance, and production planning visibility. Next recommended task: Production Auth/RBAC v1 planning, or GitHub App controlled implementation v1 if secret backend planning is sufficiently mature.
