...
The existing `docs/phase-4-preparation-blocked.md` also records that Phase 4 Preparation was blocked because Phase 3 Packaging & Versioning v3 validation is not passing.
