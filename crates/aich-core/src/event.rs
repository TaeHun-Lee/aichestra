...
pub enum EventName {
    ...
    SessionAgentFailed,
    SessionReworkStarted,
    SessionReworkCompleted,
    SessionReworkFailed,
    SessionCompleted,
    SessionReopened,
    SessionAbandoned,
...
impl EventName {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SessionReworkStarted => "session.rework.started",
            Self::SessionReworkCompleted => "session.rework.completed",
            Self::SessionReworkFailed => "session.rework.failed",
            Self::SessionCompleted => "session.completed",
            Self::SessionReopened => "session.reopened",
            ...
            Self::ManifestUpdated => "manifest.updated",
