...
test("dashboard data providers support demo, API, and explicit fallback modes", async () => {
  ...
  const endpoints = new Map<string, unknown>([
    ...
    ["/dashboard/merge-queue-integration", { mergeQueueIntegration: demo.mergeQueueIntegration }],
    ["/dashboard/git-cleanup", { branchCleanup: demo.branchCleanup }],
    ["/dashboard/registry-compatibility", { registryCompatibility: demo.registryCompatibility }],
    ["/dashboard/registry-drift", { registryDrift: demo.registryDrift }],
    ["/dashboard/registry-canary-apply", { registryCanaryApply: demo.registryCanaryApply }],
    ["/dashboard/scope-filter", { dashboardScopeFilter: demo.dashboardScopeFilter }],
