...
const dashboardTenantScopePlans: DashboardTenantScopePlan[] = [
  ...
  dashboardPlan({ id: "merge_queue_integration", name: "Merge Queue live integration-test readiness", source: "GET /dashboard/merge-queue-integration", scopes: ["tenant", "team", "project", "repo"], roles: adminRoles, redaction: "internal_metadata", productionImpact: "Merge queue live-test gate metadata must remain scoped before any live integration test use." }),
  dashboardPlan({ id: "registry_compatibility", name: "Skill/Harness Compatibility Matrix v1", source: "GET /dashboard/registry-compatibility", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", productionImpact: "Compatibility matrix metadata must remain advisory and never bypass registry resolver gates." }),
  dashboardPlan({ id: "registry_drift", name: "Skill/Harness Drift Detection v1", source: "GET /dashboard/registry-drift", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", productionImpact: "Drift detection metadata must remain advisory and never auto-apply, mutate active registry entries, or execute eval/canary." }),
  dashboardPlan({ id: "registry_canary_apply", name: "Canary Execution Harness + Apply Workflow v1", source: "GET /dashboard/registry-canary-apply", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", productionImpact: "Canary execution and apply workflow metadata must remain mock-first and metadata-only, never enable auto-apply, mutate active registry entries, execute real canary/eval, or call external providers." }),
...
const readinessTenantScopePlans: ReadinessTenantScopePlan[] = [
  ...
  readinessPlan({ id: "merge_queue_integration", group: "Merge Queue Live Integration Tests", pattern: "/readiness/merge-queue-integration/*", source: "DeploymentReadinessService merge queue integration-test profile", scopes: ["tenant", "team", "project", "repo"], roles: adminRoles, redaction: "internal_metadata", hideDetailsForLowerRoles: true, productionImpact: "Merge queue live-test readiness must remain repo-scoped and never expose env values or branch names." }),
  readinessPlan({ id: "registry_compatibility", group: "Registry Compatibility Matrix", pattern: "/readiness/registry/compatibility/*", source: "RegistryCompatibilityService summary", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", hideDetailsForLowerRoles: false, productionImpact: "Compatibility readiness must remain advisory and never bypass registry resolver gates." }),
  readinessPlan({ id: "registry_drift", group: "Registry Drift Detection", pattern: "/readiness/registry/drift/*", source: "RegistryDriftDetectionService summary", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", hideDetailsForLowerRoles: false, productionImpact: "Drift readiness must remain advisory and never auto-apply, mutate registry entries, or execute eval/canary." }),
  readinessPlan({ id: "registry_canary", group: "Registry Canary Execution Harness", pattern: "/readiness/registry/canary/*", source: "CanaryExecutionService + ApplyWorkflowService summary", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", hideDetailsForLowerRoles: false, productionImpact: "Canary execution readiness must remain mock-first and metadata-only, never run real canary, and never mutate registry entries." }),
  readinessPlan({ id: "registry_apply_workflow", group: "Registry Apply Workflow", pattern: "/readiness/registry/apply-workflows/*", source: "ApplyWorkflowService summary", scopes: ["tenant", "team", "project", "registry_package"], roles: adminRoles, redaction: "internal_metadata", hideDetailsForLowerRoles: false, productionImpact: "Apply workflow readiness must remain metadata-only, never execute real apply, and never enable auto-apply or active registry mutation." }),
