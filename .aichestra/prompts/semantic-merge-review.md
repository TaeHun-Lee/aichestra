...
- Test results
- Local MVP review input artifact, possibly marked `llm_executed: false`
...
- If the input was first generated by the local MVP reviewer, treat it as evidence to audit, not as proof of safety.
