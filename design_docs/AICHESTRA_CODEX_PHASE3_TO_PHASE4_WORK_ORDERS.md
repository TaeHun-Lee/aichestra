...
- docs/bootstrap-gap-report.md, if present
- docs/phase-progress-audit.md, if present
- docs/phase-1-2-completion-audit.md, if present
- docs/phase-2-completion-gap.md, if present
- docs/conflict-manager-v0.md, if present
- docs/conflict-manager-v1.md, if present
- docs/phase-3-registry-v0.md, if present
- docs/phase-3-registry-hardening-v1.md, if present
- docs/phase-3-completion-gap.md, if present
...
docs/phase-3-operational-hardening-v2-plan.md
...
- docs/phase-3-registry-v0.md, if present
- docs/phase-3-registry-hardening-v1.md, if present
- docs/phase-3-operational-hardening-v2.md, if present
- docs/phase-3-completion-gap.md, if present
...
docs/phase-3-packaging-versioning-v3-plan.md
...
- docs/phase-3-registry-hardening-v1.md, if present
- docs/phase-3-operational-hardening-v2.md, if present
- docs/phase-3-packaging-versioning-v3.md, if present
- docs/phase-3-completion-gap.md, if present
...
docs/phase-4-preparation-blocked.md
...
- docs/phase-3-operational-hardening-v2.md, if present
- docs/phase-3-packaging-versioning-v3.md, if present
- docs/phase-4-preparation.md, if present
